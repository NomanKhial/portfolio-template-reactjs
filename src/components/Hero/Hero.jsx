...
export default function Hero() {
  return (
    <section className=" mt-[140px]">
      <section className="max-w-[92%] flex flex-col gap-4 items-center mx-auto md:h-screen mt-10 relative my-20">
        <div className=" text-slate-900 font-bold text-center flex flex-col">
          <span>- Hello</span>
          <h2
